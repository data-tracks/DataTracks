...
pub mod data_model {
    ...
    impl<'a> Text<'a> {
        ...
        pub fn value(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(Text::VT_VALUE, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TextBuilder<'a, 'b, A> {
        ...
        pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Text::VT_VALUE, value);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ArrayBuilder<'a, 'b, A> {
        ...
        pub fn add_values(
            ...
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Array::VT_VALUES, values);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    ...
    impl<'a> DictEntry<'a> {
        ...
        pub fn key(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(DictEntry::VT_KEY, None)
            }
        }
        #[inline]
        pub fn value(&self) -> Option<Value<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<Value>>(DictEntry::VT_VALUE, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> DictEntryBuilder<'a, 'b, A> {
        ...
        pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(DictEntry::VT_KEY, key);
        }
        #[inline]
        pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<Value<'b>>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<Value>>(DictEntry::VT_VALUE, value);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> DictEntryBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            DictEntryBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    impl<'a> Dict<'a> {
        ...
        pub fn entries(
            &self,
        ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<DictEntry<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<DictEntry>>,
                >>(Dict::VT_ENTRIES, None)
            }
        }
    }
    ...
    impl ::flatbuffers::Verifiable for Dict<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<DictEntry>>,
    ...
    pub struct DictArgs<'a> {
        pub entries: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<DictEntry<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> DictBuilder<'a, 'b, A> {
        ...
        pub fn add_entries(
            ...
            entries: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<DictEntry<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Dict::VT_ENTRIES, entries);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> NodeBuilder<'a, 'b, A> {
        ...
        pub fn add_labels(
            ...
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Node::VT_LABELS, labels);
        }
        #[inline]
        pub fn add_properties(
            ...
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Node::VT_PROPERTIES, properties);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    ...
    impl<'a> Edge<'a> {
        ...
        pub fn label(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<&str>>(Edge::VT_LABEL, None)
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> EdgeBuilder<'a, 'b, A> {
        ...
        pub fn add_label(&mut self, label: ::flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Edge::VT_LABEL, label);
        }
        #[inline]
        ...
        pub fn add_properties(
            ...
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Edge::VT_PROPERTIES, properties);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    ...
    impl<'a> Value<'a> {
        ...
        pub fn data_type(&self) -> ValueData {
            ...
            unsafe {
                self._tab
                    .get::<ValueData>(Value::VT_DATA_TYPE, Some(ValueData::NONE))
                    .unwrap()
            }
        }
        #[inline]
            ...
            v.visit_table(pos)?
                .visit_union::<ValueData, _>(
                    ...
                    |key, v, pos| match key {
                        ...
                        ValueData::Text => v
                            .verify_union_variant::<::flatbuffers::ForwardsUOffset<Text>>(
                                "ValueData::Text",
                                pos,
                            ),
                        ValueData::Time => v
                        ...
                        ValueData::Array => v
                            .verify_union_variant::<::flatbuffers::ForwardsUOffset<Array>>(
                                "ValueData::Array",
                                pos,
                            ),
                        ValueData::Dict => v
                        ...
                        ValueData::Node => v
                            .verify_union_variant::<::flatbuffers::ForwardsUOffset<Node>>(
                                "ValueData::Node",
                                pos,
                            ),
                        ValueData::Edge => v
                            .verify_union_variant::<::flatbuffers::ForwardsUOffset<Edge>>(
                                "ValueData::Edge",
                                pos,
                            ),
                        _ => Ok(()),
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ValueBuilder<'a, 'b, A> {
        ...
        pub fn add_data_type(&mut self, data_type: ValueData) {
            self.fbb_
                .push_slot::<ValueData>(Value::VT_DATA_TYPE, data_type, ValueData::NONE);
        }
        #[inline]
        pub fn add_data(&mut self, data: ::flatbuffers::WIPOffset<::flatbuffers::UnionWIPOffset>) {
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Value::VT_DATA, data);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> MessageBuilder<'a, 'b, A> {
        ...
        pub fn add_topics(
            ...
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Message::VT_TOPICS, topics);
        }
        #[inline]
        pub fn add_payload(
            &mut self,
