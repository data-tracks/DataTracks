...
impl ConfigModel {
    pub fn text<S: AsRef<str>>(text: S) -> ConfigModel {
        ConfigModel::String(StringModel::new(text.as_ref()))
    }
...
impl ContainerConfig {
    pub fn new(name: String, configs: HashMap<String, ConfigModel>) -> ContainerConfig {
        ContainerConfig { name, configs }
    }
}
...
impl StringModel {
    pub fn new<S: AsRef<str>>(string: S) -> StringModel {
        StringModel {
...
impl NumberModel {
    pub fn new(number: i64) -> NumberModel {
        NumberModel {
            base_config: BaseConfig::default(),
            number,
        }
